            ...
            <div className="order-page-top">
                <div className="thank-you-wrapper">
                    ...
                    <div className="order-changes">
                        <p className="order-changes-text">Need to make changes? Visit your order details page as soon as possible. You won't be able to edit your order once it starts processing.</p>
                    </div>
                </div>
            </div>
